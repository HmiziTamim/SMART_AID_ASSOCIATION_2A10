...
#include <QtSerialPort/QSerialPort>//classe contenant des fonctions permettant l'echange des données
#include <QtSerialPort/QSerialPortInfo>//classe fournissant des info sur les ports
#include <QDebug>

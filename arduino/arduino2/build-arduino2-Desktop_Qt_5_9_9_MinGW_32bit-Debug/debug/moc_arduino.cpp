...
QT_MOC_LITERAL(1, 8, 10), // "gotNewData"
QT_MOC_LITERAL(2, 19, 0), // ""
QT_MOC_LITERAL(3, 20, 4), // "data"
QT_MOC_LITERAL(4, 25, 7) // "newData"

    },
    "arduino\0gotNewData\0\0data\0newData"
};
...
void arduino::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&arduino::gotNewData)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void arduino::gotNewData(QByteArray _t1)
{

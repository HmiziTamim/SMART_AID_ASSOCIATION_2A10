...
void ApexAlliance::ChatSocket::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ChatSocket *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (ChatSocket::*)(ChatSocket * );
        ...
        {
            using _t = void (ChatSocket::*)(ChatSocket * , int );
...
QT_INIT_METAOBJECT const QMetaObject ApexAlliance::ChatSocket::staticMetaObject = { {
    QMetaObject::SuperData::link<QTcpSocket::staticMetaObject>(),
    qt_meta_stringdata_ApexAlliance__ChatSocket.data,
    qt_meta_data_ApexAlliance__ChatSocket,
    qt_static_metacall,
    nullptr,
    nullptr
} };
